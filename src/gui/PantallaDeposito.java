...
public class PantallaDeposito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        depositoText = new javax.swing.JTextField();
        ...
        jLabel2.setText("Digite la cantidad a depositar:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 500, 20));

        depositoText.setBackground(new java.awt.Color(255, 255, 255));
        depositoText.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        depositoText.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        depositoText.setBorder(null);
        jPanel1.add(depositoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, 160, 30));

        btnDepositar.setBackground(new java.awt.Color(173, 193, 137));
        btnDepositar.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        ...
        jPanel1.add(btnDepositar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 120, 30));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 160, 10));

        atrasText.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        ...
        jPanel1.add(atrasText, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 470, -1, -1));
    ...
    private void btnDepositarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDepositarMouseClicked
        ...
        if(depositoText.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Debe llenar todos los campos.");
        }else if(!depositoText.getText().trim().matches("\\d+")){
            JOptionPane.showMessageDialog(null, "El campo sólo puede contener números.");
        }else{
            fondos = 0;
            cantidad = Integer.parseInt(depositoText.getText());
            ...
            try{
                ...
                sqlTransaccion = "insert into transacciones (cedula_cliente,tipo_transaccion,cantidad) values ('"+pl.cedula+"','Depósito','"+cantidad+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaDeposito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaDeposito().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField depositoText;
